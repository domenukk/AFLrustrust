...
Speed wise, this is very comparable for my test binary.
Please report stats.
...
The rust mode was 100% autogenerated off the current dev version of afl++. 
You might need to install c2rust. 
For Linux: 
```bash 
